function filterMain(countyid, subcountyid, periodid) {
        ...
        var url = 'https://testhis.uonbi.ac.ke/api/26/analytics.json?dimension=pe:'+periodid+'&dimension=dx:HfGVoCZAwtd;nK8sqMAeQHY;ZcngDQJKiEg;wOKbEd8Dbi3;lHPLS1G5CUc;SSARcWY2Ge1;AX1co0SXobM;UUNwkYQhYgX&dimension=ou:'+countyid+'&displayProperty=NAME&outputIdScheme=UID';
        ...
        var urlfa = 'https://testhis.uonbi.ac.ke/api/26/analytics.json?dimension=dx:HfGVoCZAwtd;nK8sqMAeQHY;ZcngDQJKiEg;wOKbEd8Dbi3;SSARcWY2Ge1;AX1co0SXobM;UUNwkYQhYgX&dimension=ou:'+countyid+';LEVEL-5&filter=pe:'+periodid+'&displayProperty=NAME&outputIdScheme=UID';
