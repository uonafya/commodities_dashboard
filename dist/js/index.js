...
function fetchPercHealthFA(urlfa,itemnames,countyid,periodid){
    ...
    error: function (request, status, error) {
            ...
            $('.t_one_state').html('<div class ="alert alert-danger"><strong>Data Error: '+request.responseText+'</strong><br/>Failed to load this data. Please <a href="#" class="btn btn-xs btn-primary btn-rounded" onclick="window.location.reload(true)">refresh</a> this page to retry</div>');
        }
    });
}
