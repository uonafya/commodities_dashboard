    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // commodity name
                ...
                // $.getJSON('https://testhis.uonbi.ac.ke/api/26/dataElements/'+commd+'.json', function (data){
...
function makeList(name){
 ...
 function popComms(commarr){
    ...
    $.each(commodity_id_arrays_clean, function (index, commodity_id) {
        $.getJSON('https://testhis.uonbi.ac.ke/api/26/dataElements/'+commodity_id+'.json', function (data) 
        {
           var co_ar = []
